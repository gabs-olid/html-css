...
namespace chuj.xyz
{
    public class UI : MonoBehaviour
    {
        ...
        public float viewmodelFovX = 0f;
        public float viewmodelFovY = 0f;
        public float viewmodelFovZ = 0f;
        ...
        private void MainWindow(int id)
        {
            ...
            switch (tabs)
            {
                ...
                case 2: // Misc
                    ...
                    GUILayout.BeginHorizontal();
                    GUILayout.Label("X: " + (float)Math.Round(viewmodelFovX, 1), labelStyle, GUILayout.Width(80f));
                    GUILayout.BeginVertical(GUILayout.ExpandWidth(true));
                    GUILayout.FlexibleSpace();
                    viewmodelFovX = GUILayout.HorizontalSlider(viewmodelFovX, -10f, 10f);
                    GUILayout.EndVertical();
                    GUILayout.EndHorizontal();

                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Y: " + (float)Math.Round(viewmodelFovY, 1), labelStyle, GUILayout.Width(80f));
                    GUILayout.BeginVertical(GUILayout.ExpandWidth(true));
                    GUILayout.FlexibleSpace();
                    viewmodelFovY = GUILayout.HorizontalSlider(viewmodelFovY, -10f, 10f);
                    GUILayout.EndVertical();
                    GUILayout.EndHorizontal();

                    GUILayout.BeginHorizontal();
                    GUILayout.Label("Z: " + (float)Math.Round(viewmodelFovZ, 1), labelStyle, GUILayout.Width(80f));
                    GUILayout.BeginVertical(GUILayout.ExpandWidth(true));
                    GUILayout.FlexibleSpace();
                    viewmodelFovZ = GUILayout.HorizontalSlider(viewmodelFovZ, -10f, 10f);
                    GUILayout.EndVertical();
                    GUILayout.EndHorizontal();
